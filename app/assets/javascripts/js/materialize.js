              ...
              if (val.length >= options.minLength) {
                for(var key in data) {
                  if (data.hasOwnProperty(key) &&
                    ...
                    if (!!data[key]) {
                      autocompleteOption.append('<img src="assets/'+ data[key] +'" class="right circle"><span>'+ key +'</span>');
                    } else {
    ...
    $(this).each(function(){
      ...
      var appendOptionWithIcon = function(select, option, type) {
        ...
        if (!!icon_url) {
          ...
          options.append($('<li class="' + disabledClass + optgroupClass + '"><img alt="" src="assets/' + icon_url + '"' + classString + '><span>' + multipleCheckbox + option.html() + '</span></li>'));
          return true;
        }
